...
_URL_ALL_SEMESTER = _URL_PREF + 'MyCourse.jsp?typepage=3'
...
_URL_SPEC_NEW = 'http://learn.cic.tsinghua.edu.cn/b/mycourse/SpeakTeacher/'
...
_COURSE_TEACHER_NEW = 'http://learn.cic.tsinghua.edu.cn/b/mycourse/SpeakTeacher/list/%s'
_COURSE_INFO_NEW = 'http://learn.cic.tsinghua.edu.cn/b/mycourse/courseExtension/getCourseExtensionByCourseId/%s'
